 ...
 * 
 * @param fen {string} - current game status in FEN notation
 * @param id_game {number} - ID of the game to which the information belongs
 * @param color {boolean} - tells the recipient which color he/she has (false = white, true = black)
 * @param turns {array} - contains all possible turns as strings (e.g. "e2e4")
 * 
 ...
 * 
 * @param username {string} username - The username of the new user
 ...
 * 
 * @param FEN {string} - initial board positions in FEN-notation
 * @param ID_enemy {string} - ID of the inviting player
 * 
 * @returns {object} object which contains the parameters in combined form
 */
 ...
 * Used for sharing or confirming a move or a picture  
 * 
 * @param reason {string} - current game status in FEN notation
 * @param ID_game {number} - ID of the game to which the information belongs
 * @param ID_Player {boolean} - tells the recipient which color he/she has (false = white, true = black)
 * 
 * @returns {object} object which contains the parameters in combined form
 */
 ...
 * 
 * @param data {string} - the message string
 *
