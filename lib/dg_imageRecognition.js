 ...
 * 
 * @param {buffer object} - the buffer object in which the picture is stored in base64 coding
 * @param {string} - the path to the python file in which the calculations take place
 * 
...
function getFEN(buffer, pyModulePath) {
    return new Promise((resolve, reject) => {
        ...
        ImageReader.stdout.on('end', (chunk) => {
            procDone = true;
